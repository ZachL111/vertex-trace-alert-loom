"""Regression checks for the vertex-trace-alert-loom casebook."""
...
from casebook.harness import assert_expected, vertex_trace_alert_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(vertex_trace_alert_loom_summary(), assert_expected())
